...
from aide_predict.bespoke_models.base import ProteinModelWrapper, RequiresMSAForFitMixin, PositionSpecificMixin, CanHandleAlignedSequencesMixin, RequiresFixedLengthMixin, ShouldRefitOnSequencesMixin
...
class OneHotAlignedEmbedding(ShouldRefitOnSequencesMixin, PositionSpecificMixin, RequiresMSAForFitMixin, CanHandleAlignedSequencesMixin, ProteinModelWrapper):
    """
